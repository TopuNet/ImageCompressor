...
var ImageCompressor = {
        ...
        $(args.form_id).submit(function() {
            ...
            rotate_img.onload = function() {
                ...
                crop_img.onload = function() {
                    var imgCompressed = ImageCompressor.Compress(crop_img, ImageCompressor.quality);
                ...
                // ImageCompressor.getImg64(rotate_img, function(_img64) {
    ...
    Compress: function(img, quality) {
        ...
        //ratio = 0.9;
        var img1 = canvas.toDataURL(ImageCompressor.getMimeType(img.src), ratio);
     ...
     *@高京
     *@20150914
     *@根据图片的Base64码获得mimeType（非jpg则为png）
     *@imgSrc：图片Base64码的src
     */
